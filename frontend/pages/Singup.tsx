  ...
  return (
    <>
      ...
      <div className="signup-root min-h-screen  flex items-center justify-center p-4 relative overflow-hidden">
        ...
        <div className="float-shape absolute top-16 left-16 w-64 h-64 bg-violet-500/10 rounded-full blur-3xl pointer-events-none" />
        <div className="float-shape-2 absolute bottom-16 right-16 w-80 h-80 bg-blue-500/10 rounded-full blur-3xl pointer-events-none" />
        <div className="float-shape absolute top-1/2 left-1/3 w-48 h-48 bg-pink-500/5 rounded-full blur-2xl pointer-events-none" />
